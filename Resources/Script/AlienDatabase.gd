...
var Alien = {
	"Blando" : [
		"How can an alien be so... basic? people says It's the most basic species in the galaxy. Not aggressive not passive. It doesnt morph, breath fire, teleport, or melt reality. It just stands there, 
		taking up space and breathing your expensive oxygen.",
		"No trait, just vibes.",
